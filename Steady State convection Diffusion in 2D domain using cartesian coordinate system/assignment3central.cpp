...
int main(){
    ...
    for(i =0;i<n;i++){
        for(j=0;j<n;j++){
            if(i==0 & j==0){
                ...
                ap[i][j] = De[i][j]+Fe[i][j]/2+Dw[i][j]+Dn[i][j]+Fn[i][j]/2+Ds[i][j];
            }
                ...
                an[i][j] = Dn[i][j]-Fn[i][j]/2;
                as[i][j] = Ds[i][j]+Fs[i][j];
                ap[i][j] = Fe[i][j]+Dw[i][j]-Fw[i][j]/2+Dn[i][j]+Fn[i][j]/2+Ds[i][j];
                ...
                an[i][j] = Dn[i][j]-Fn[i][j]/2;
                as[i][j] = Ds[i][j]+Fs[i][j];
                ap[i][j] = De[i][j]+Fe[i][j]/2+Dw[i][j]-Fw[i][j]/2+Dn[i][j]+Fn[i][j]/2+Ds[i][j];
            }
                ...
                ap[i][j] = De[i][j]+Fe[i][j]/2+Dw[i][j]+Fn[i][j]+Ds[i][j]-Fs[i][j]/2;
                ...
                an[i][j] = 0;
                as[i][j] = Ds[i][j]+Fs[i][j]/2;
                ap[i][j] = Fe[i][j]+Dw[i][j]-Fw[i][j]/2+Fn[i][j]+Ds[i][j]-Fs[i][j]/2;
            }
                ...
                an[i][j] = 0;
                as[i][j] = Ds[i][j]+Fs[i][j]/2;
                ap[i][j] = De[i][j]+Fe[i][j]/2+Dw[i][j]-Fw[i][j]/2+Fn[i][j]+Ds[i][j]-Fs[i][j]/2;
            }
                ...
                an[i][j] = Dn[i][j]-Fn[i][j]/2;
                as[i][j] = Ds[i][j]+Fs[i][j]/2;
                ap[i][j] = De[i][j]+Fe[i][j]/2+Dw[i][j]+Dn[i][j]+Fn[i][j]/2+Ds[i][j]-Fs[i][j]/2;
            }
                ...
                an[i][j] = Dn[i][j]-Fn[i][j]/2;
                as[i][j] = Ds[i][j]+Fs[i][j]/2;
                ap[i][j] = Fe[i][j]+Dw[i][j]-Fw[i][j]/2+Dn[i][j]+Fn[i][j]/2+Ds[i][j]-Fs[i][j]/2;
            }
                ...
                an[i][j] = Dn[i][j]-Fn[i][j]/2;
                as[i][j] = Ds[i][j]+Fs[i][j]/2;
                ap[i][j] = De[i][j]+Fe[i][j]/2+Dw[i][j]-Fw[i][j]/2+Dn[i][j]+Fn[i][j]/2+Ds[i][j]-Fs[i][j]/2;
            }
        ...
        for(i=0;i<n;i++){
            for(j=0;j<n;j++){
                ...
                if(i==0 & j==0){
                    ...
                    if (j==n-1) { phi[i][j] = (aw[i][j]*phi[i][j-1]+an[i][j]*phi[i+1][j]+as[i][j]*phiSouth+s[i][j])/ap[i][j]; }
                    else { 
                    ...
                    if(i==n-1) phi[i][j] = (ae[i][j]*phi[i][j+1]+aw[i][j]*phiWest+as[i][j]*phi[i-1][j]+s[i][j])/ap[i][j];
                    else{
                    ...
                    if(i==n-1 & j==n-1) phi[i][j] = (aw[i][j]*phi[i][j-1] + as[i][j]*phi[i-1][j] + s[i][j])/ap[i][j];
                    else if (j==n-1 & i!=n-1) phi[i][j] = (aw[i][j]*phi[i][j-1] + an[i][j]*phi[i+1][j] + as[i][j]*phi[i-1][j] + s[i][j])/ap[i][j];
                    else if (i==n-1 & j!=n-1) phi[i][j] = (ae[i][j]*phi[i][j+1] + aw[i][j]*phi[i][j-1] + as[i][j]*phi[i-1][j] + s[i][j])/ap[i][j];
                    else{
    ...
    for(i=0;i<n;i++){
       cout<<"phi "<<i+1<<"   :"<<(phi[n/2-1][i]+phi[n/2][i])/2<<endl;
    }

    ofstream file1;
    file1.open("cds20.csv");
